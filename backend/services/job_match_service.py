...
class JobMatchService:
    ...
    Loads pre-trained artifacts from Best_Job.ipynb.
    """
    ...
    def __init__(self, models_dir: str = None):
        """
        Load the three pickled artefacts produced by Best_Job.ipynb.
        models_dir defaults to the project root (one level above the backend).
        """
